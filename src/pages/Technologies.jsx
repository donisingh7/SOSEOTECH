...
export default function Technologies() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Sections — image left, content right (like your 2nd screenshot) */}
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Right: content card (About + highlighted word vibe) */}
                <div>
                  {/* Big heading like “About SOSEOTECH” */}
                  <h2 className="text-3xl md:text-4xl font-extrabold text-neutral-900 mb-3">
                    About <span className="text-yellow-500">{t.title}</span>
                  </h2>

                  {/* Icon + subtitle row */}
                  <div className="flex items-center gap-3 mb-4">
                    <span
                      className={`inline-flex h-10 w-10 items-center justify-center rounded-xl ${ic.bg}`}
                      aria-hidden="true"
                    >
                      <Icon className={`h-5 w-5 ${ic.fg}`} />
                    </span>
                    <p className="text-[14px] md:text-[15px] text-neutral-500">{t.subtitle}</p>
                  </div>

                  {/* Main paragraphs */}
                  <p className="text-[16px] md:text-[17px] leading-8 text-neutral-800 text-justify mb-3">
                    {t.summary}
                  </p>
