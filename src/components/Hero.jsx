    ...
    <section id="home" className="scroll-mt-24 bg-[#F6F5F3]">
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-16 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            <h1 className="font-serif font-extrabold tracking-tight text-slate-900
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#contact-us"
                className="inline-flex items-center justify-center rounded-xl bg-yellow-500
                           px-6 py-3 font-semibold text-black hover:bg-yellow-400 transition"
              >
                Get in Touch
              </a>
              <a
                href="#services"
                className="inline-flex items-center justify-center rounded-xl border border-slate-900/80
                           px-6 py-3 font-semibold text-slate-900 hover:bg-slate-900 hover:text-white transition"
              >
                Our Services
              </a>
            </div>
          ...
          {/* RIGHT: Media card with soft background panel */}
          <div className="relative">
            {/* subtle light panel behind the card (like Mailchimp) */}
            ...
            <div className="rounded-[28px] bg-white shadow-2xl ring-1 ring-black/5 overflow-hidden">
              <img
                src="/hero.jpg"   /* put your hero preview here */
